...
class UserProfile(models.Model):
    ...
    default_street_address1 = models.TextField(max_length=20, blank=True, null=True)
    default_street_address2 = models.TextField(max_length=20, blank=True, null=True)
