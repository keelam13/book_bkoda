...
- The app can be reached by the [link](https://book-bkoda-6d62942dbe76.herokuapp.com/).
...
- Clone the repository:
  ...
  - `git clone https://github.com/keelam13/book_bkoda.git`
...
2. Create a `.env` file. This will contain the following environment variables:
...
3. Run the following commands in a terminal to make migrations: 
    - `python3 manage.py makemigrations`
    - `python3 manage.py migrate`
4. Create a superuser to get access to the admin environment.
    - `python3 manage.py createsuperuser`
    - Enter the required information (your username, email and password).
5. Run the app with the following command in the terminal:
    - `python3 manage.py runserver`
6. Open the link provided in a browser to see the app.

7. If you need to access the admin page:
